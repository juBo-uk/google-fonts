...
echo "</p><p>[1] First choose your <strong>Title Font</strong> from the selection at <a style='color:blue; text-decoration:underline' href='http://www.google.com/fonts'>Google Fonts</a> <em>(example = 'Molengo', 'Abril+Fatface', etc...)</em></p>";  

	if(empty($vars['entity']->gf_headfont)){
	$vars['entity']->gf_headfont = "Molengo";
	}
...
echo "<br /><br /><p>[3] Title Font Style - from Font Family options<em>(example = 'italic', 'normal')</em></p>";
  ...
  $vars['entity']->gf_headfont_style = "normal";
  }
...
echo "<br /><br /><p>[5] Height of header panel - you might need to change this (just a little) to make your title font look better <em>(example = '90px')</em></p>";


	if(empty($vars['entity']->gf_headfont_height)){
	$vars['entity']->gf_headfont_height = "90px";
	}
...
echo "<br /><br /><p>[6] Title Font Colour <em>(example = '#fff')</em></p>";
...
<?php																				
echo "<br /><br /><p>[1] Next choose your <strong>Body Font</strong> <em>(example = 'Gudea', 'Droid+Serif', etc... )</em></p>";
